...
namespace LoncotesLibrary.Migrations
{
    ...
    [Migration("20230912193729_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoncotesLibrary.Models.Checkout", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CheckoutDate = new DateTime(2023, 9, 12, 14, 37, 29, 25, DateTimeKind.Local).AddTicks(5703),
                            MaterialId = 1,
                            PatronId = 1,
                            ReturnDate = new DateTime(2023, 9, 19, 14, 37, 29, 25, DateTimeKind.Local).AddTicks(5738)
                        },
                        new
                        {
                            Id = 2,
                            CheckoutDate = new DateTime(2023, 9, 9, 14, 37, 29, 25, DateTimeKind.Local).AddTicks(5740),
                            MaterialId = 5,
                            PatronId = 2,
                            ReturnDate = new DateTime(2023, 9, 16, 14, 37, 29, 25, DateTimeKind.Local).AddTicks(5742)
                        },
                        new
                        {
                            Id = 3,
                            CheckoutDate = new DateTime(2023, 9, 2, 14, 37, 29, 25, DateTimeKind.Local).AddTicks(5743),
                            MaterialId = 10,
                            PatronId = 3
                        },
                        new
                        {
                            Id = 4,
                            CheckoutDate = new DateTime(2023, 9, 5, 14, 37, 29, 25, DateTimeKind.Local).AddTicks(5746),
                            MaterialId = 8,
                            PatronId = 4
                        },
                        new
                        {
                            Id = 5,
                            CheckoutDate = new DateTime(2023, 9, 7, 14, 37, 29, 25, DateTimeKind.Local).AddTicks(5747),
                            MaterialId = 15,
                            PatronId = 5,
                            ReturnDate = new DateTime(2023, 9, 15, 14, 37, 29, 25, DateTimeKind.Local).AddTicks(5748)
                        });
                });
            ...
            modelBuilder.Entity("MaterialPatron", b =>
                {
                    ...
                    b.HasKey("MaterialsId", "PatronsId");

                    b.HasIndex("PatronsId");

                    b.ToTable("MaterialPatron");
                });
            ...
            modelBuilder.Entity("MaterialPatron", b =>
                {
                    b.HasOne("LoncotesLibrary.Models.Material", null)
                        .WithMany()
                        .HasForeignKey("MaterialsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LoncotesLibrary.Models.Patron", null)
                        .WithMany()
